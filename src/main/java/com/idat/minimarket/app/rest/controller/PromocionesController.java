...
public class PromocionesController {
    ...
    public ResponseEntity<Object> actualizar(@PathVariable("id") Integer id, @RequestBody Promociones promocionesActualizar) 
    {
       
		Promociones promociones = this.service.buscarPorId(id);

		if(promociones == null){
			return new ResponseEntity<>(null, HttpStatus.NOT_FOUND);
		}else{
			promocionesActualizar.setId(id);
			return new ResponseEntity<>(this.service.update(promocionesActualizar),HttpStatus.OK);
		}
    }
}
